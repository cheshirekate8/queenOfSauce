  ...
  return (
    <div className="kitchenDiv">
      <h1 className="kitchenTitle">
        {sessionUser.username}'s Kitchen
        <NewFridgeModal />
      </h1>
      {fridges && fridges.length > 0 ? (
            ...
            <div className="fridgeTitle" id={fridge.name}>
              ...
              <div>
                ...
                <i
                  ...
                  onClick={() =>
                    dispatch(kitchenActions.deleteFridge(fridge.id))
                  }
                ></i>
              </div>
            </div>
              ...
              {fridge.FridgeIngredients.map((ingredient) => (
                <div className="oneIngDiv">
                  ...
                  <div
                    ...
                    onClick={() =>
                      dispatch(
                        kitchenActions.deleteFromFridge(
                          ingredient.id,
                          sessionUser.id,
                        ),
                      )
        ...
        <div>
          You have no refrigerators! Create one by clicking the + sign on the
          right!
        </div>
      )}
    </div>
